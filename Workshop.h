...
class Workshop {
    ...
    int number;  // 工作台自身编号
    type_workshop typeWorkshop;//对应工作台类型说明
public:
    Workshop();
    ...
    void set_type(type_workshop typeWorkshop1);
    const type_workshop &get_type() const;

    int set_type_workshop(int workType,int itemtype);
